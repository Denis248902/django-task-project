...
from employees.models import EmployeeProfile, Skill, EmployeeSkillLevel
...
print(f"✅ Профиль сотрудника: {employee.first_name} {employee.middle_name or ''} {employee.last_name}")

# 3. Рабочее место
workplace, created = Workplace.objects.get_or_create(
    desk_number="101",
    defaults={'extra_info': 'Главный офис, Москва'}
)
